...
import { Barber } from "../../barber/base/Barber";
...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        barber: args.data.barber
          ? {
              connect: args.data.barber,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => Barber, {
    nullable: true,
    name: "barber",
  })
  async getBarber(@graphql.Parent() parent: Booking): Promise<Barber | null> {
    const result = await this.service.getBarber(parent.id);
